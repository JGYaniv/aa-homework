...
View.prototype.exercise5 = function () {
  ...
  $('li').click((event) => {
    alert(`${$( event.currentTarget ).data("pos")}`);
  })
...
View.prototype.exercise6 = function () {
  ...
  $('li').each(function(){
    this.style.background = window._randomColorString();
  })
  //your code here!
};
